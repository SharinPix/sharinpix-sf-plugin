...
(function(root){
	...
	root.OI = OI||root.OI||{};
	// SHARINPIX CHANGED: use same-origin path so dynamic load is never chrome-extension://
	// (avoids "Denying load" when page runs in extension context). Original: path from last script .src
	var origin = (typeof location !== 'undefined' && location.origin) ? location.origin : '';
	var editor = origin + '/oi.csv.editor.js';
