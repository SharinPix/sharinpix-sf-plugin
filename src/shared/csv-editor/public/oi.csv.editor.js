/**
	...
	SOURCE (vendored/copied for SharinPix CLI  CSV editor):
	https://open-innovations.github.io/oi.csv.js/
	https://github.com/open-innovations/oi.csv.js
...
(function(root){
	...
	OI.CSVEditor = function(lnk,opts){
		...
		this.updateTable = function(nosave){
			...
			if(!table){
				...
				// SHARINPIX CHANGED: label "Save" -> "Download" (this button downloads only; toolbar Save overwrites file)
				addButton(menubar,{'label':'Download','html':'<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16"><path d="M7.25,2h1.5v7h2l-2.75,3.5 -2.75,-3.5h2v-7zM1,15 v-4h1.5v3h11v-3h1.5v4h-14z" /></svg> Download','click':function(){ _obj.saveCSV(); }});
	...
	${t} td, ${t} th { border: 1px solid; border-right: 0; border-top: 0; border-color: var(--border); white-space: nowrap; padding: 0.25em 0.5em; }
